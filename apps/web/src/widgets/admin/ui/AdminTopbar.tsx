...
export const AdminTopbar: React.FC = () => {
  ...
  const name = session?.user.name?.trim() || "Профиль";
  ...
  return (
    <header className={cls.root}>
      ...
      <div className={cls.actions}>
        <button type="button" className={cls.iconBtn} aria-label="Уведомления">
        ...
        <Link className={cls.avatarLink} to="/profile" title="Профиль" aria-label={`Профиль, ${name}`}>
