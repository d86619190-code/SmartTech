...
const RU_DICTIONARY: Dictionary = {
  ...
  "login.resendHelp": "Не пришёл код? Нажмите «Отправить код ещё раз».",
  "login.inAppRegisterTitle": "Регистрация в этом окне недоступна",
  "login.inAppRegisterBody":
    "Во встроенных браузерах (Telegram, Instagram и др.) часто не работают вход через Google и подтверждение по коду. Откройте ссылку в Chrome или Safari: меню «⋯» → «Открыть в браузере».",
  "login.openInExternalBrowser": "Открыть в браузере",
  "login.copyPageLink": "Скопировать ссылку",
  "login.copyLinkDone": "Ссылка скопирована — вставьте её в Chrome или Safari.",
  "login.copyLinkFailed": "Не удалось скопировать. Скопируйте адрес из строки вручную.",
  "login.openBrowserTry": "Если открылось новое окно, завершите регистрацию там.",
  "login.popupBlockedHint": "Всплывающие окна заблокированы. Скопируйте ссылку и откройте её в Chrome или Safari.",
  "login.onlyLoginInApp": "Уже есть аккаунт? Вход",
  ...
  "login.electronHintBridge": "После входа сессия отправляется в приложение на 127.0.0.1 (без длинной ссылки в адресе). Запасной вариант — ссылка repair://.",
...
const EN_DICTIONARY: Dictionary = {
  ...
  "login.resendHelp": "Didn't get a code? Tap “Send code again”.",
  "login.inAppRegisterTitle": "Sign up isn't available in this in-app browser",
  "login.inAppRegisterBody":
    "Embedded browsers (Telegram, Instagram, etc.) often break Google sign-in and OTP. Open this page in Chrome or Safari (use the “⋯” menu → “Open in browser”).",
  "login.openInExternalBrowser": "Open in browser",
  "login.copyPageLink": "Copy link",
  "login.copyLinkDone": "Link copied — paste it into Chrome or Safari.",
  "login.copyLinkFailed": "Couldn't copy. Copy the address from the bar manually.",
  "login.openBrowserTry": "If a new tab opened, finish sign up there.",
  "login.popupBlockedHint": "Pop-ups blocked. Copy the link and open it in Chrome or Safari.",
  "login.onlyLoginInApp": "Already have an account? Sign in",
  ...
  "login.electronHintBridge": "After sign in, session is sent to the app on 127.0.0.1 (without long URL params). Backup option: repair:// link.",
